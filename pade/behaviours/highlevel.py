...
def FipaSubscribeProtocol(agent: ImprovedAgent, is_initiator=True):

    if is_initiator:
        instance = FipaSubscribeProtocolInitiator(agent)
    else:
        instance = FipaSubscribeProtocolParticipant(agent)
...
def FipaContractNetProtocol(agent: ImprovedAgent, is_initiator=True):

    if is_initiator:
        instance = FipaContractNetProtocolInitiator(agent)
    else:
        instance = FipaContractNetProtocolParticipant(agent)
